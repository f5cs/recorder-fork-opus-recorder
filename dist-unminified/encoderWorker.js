...
//var wasmBlob = atob(wasmBase64);
//var sliceSize = 512;
//for (var offset = 0; offset < wasmBlob.length; offset += sliceSize) {
//	let slice = wasmBlob.slice(offset, offset + sliceSize);
//
...
//
//	wasmArrayBuffData.push(byteArray);
//}
...
function integrateWasmJS() {
  ...
  function doNativeWasm(global, env, providedBuffer) {
	...
	WebAssembly.instantiate(wasmArrayBuffData,
...
var _opus_encoder_destroy = Module["_opus_encoder_destroy"] = function() {  return Module["asm"]["_opus_encoder_destroy"].apply(null, arguments) };
